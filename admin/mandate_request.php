              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <table id="datatable" class="table table-striped table-bordered">
                    ...
                    <?php
                      $loadcheck = $select->SelectMandateInfo();
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?=$value['member_balance']?></td>
                        <td><?=$value['member_prev_deduction']?></td>
                        <td><?=$value['member_new_mandate']?></td>
                        <td><?=date("nS".' - '."F".' - '."Y",strtotime($value['member_dof_joining']))?></td>
                        <th>
                            
                          <form method="POST" action="process_mandate_request.php?name=<?=$value['member_name']?>&form=loan&id=<?=$value['id']?>&member=<?=$value['member_id']?>">
                              <div class="row">
