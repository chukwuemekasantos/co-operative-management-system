<?php
  ...
  include_once './include/session_auth.php';
    ...
    $mandate = $insert->MandateIsApproved($id); 
          ...
          <div class="row">
                                ...
                                case "success":
                                   echo '
                                    <div class="alert alert-success text-center">
                                      ...
                                      <strong>Success!</strong> Mandate Form Is Approved.
                                    </div>';
                                    break;
                                case "nope":
                                    echo '
                                    <div class="alert alert-danger text-center">
                                      <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                      <strong>Sorry!</strong> Mandate Form Failed.
                                    </div>';
                                    break;
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <h3 class="text-center">Approve Mandate Form</h3>
                  <br />
                  <form method="POST" data-parsley-validate class="form-horizontal form-label-left" style="border-style: none;">
                    ...
                    <div class="form-group">
                      <div class="col-md-8 col-sm-8 col-xs-12 col-md-offset-4">
                        <a  class="btn btn-danger" onclick="window.location.href='mandate_request.php'">Back</a>
