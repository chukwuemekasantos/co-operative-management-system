...
<?php
    ...
    $mandateData = $getInfo->SelectInfoForMandateForm($member_id);
     ...
     $memberMandateForm = $insert->SubmitLoadForm();
                ...
                <div class="x_content">
                  ...
                  <form method="POST" class="form-horizontal form-label-left input_mask">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                      ...
                      <input type="text" name="member_name" class="form-control has-feedback-left" value="<?=$_SESSION['members'][1]?>" placeholder="First Name">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                      ...
                      <input type="text" name="member_id" class="form-control has-feedback-left" value="<?=$value[1]?>" placeholder="Membership/Identification Number">
                      <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                       <label  >Department/Unit</label>
                      <input type="text" name="member_department" class="form-control has-feedback-left" value="<?=$value[2]?>" placeholder="Department/Unit">
                      <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                       <label  >Date Of Joining Cooperative</label>
                      <input type="text" name="member_dof_joining" class="form-control has-feedback-left" value="<?=$value[3]?>" placeholder="">
                      <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                      ...
                      <input type="text" name="member_prev_deduction" class="form-control has-feedback-left" value="<?=$value[4]?>" placeholder="Previous Deduction">
                      <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                    </div>
