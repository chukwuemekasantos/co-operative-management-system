                  ...
                  <table id="datatable" class="table table-striped table-bordered">
                    <thead>
                      <tr>
                        ...
                        <th>Month To Start Contribution</th>
                    ...
                    <?php
                      $loadcheck = $select->SelectThriftInfo();
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?=$value['member_category']?></td>
                        <td><?=$value['member_monthly_contribute']?></td>
                        <td><?=date("F".' - '."Y",strtotime($value['member_month_to_start_contribution']))?></td>
                        
                        <td><?=date("nS".' - '."F".' - '."Y",strtotime($value['member_dof_application']))?></td>
                        <th></th>
                        ...
                        <th>
                            <form method="POST">
                              <div class="row">
                               ...
                               <div class="btn-group">
                                  <button  class="btn btn-success" type="submit" name="approve" onclick="window.location.href='loan_request.php?<?=sha1('member_load_repayment_month')?>&<?=md5('member_dof_load_applymember_dof_load_applym')?>&form=loan&member_id=<?=$value['id']?>'">
                                    <span class="docs-tooltip" data-toggle="tooltip" title="Approve Loan">
                                                      <span class="fa fa-check"></span>
                                    </span>
                                  </button>
                                  <button  class="btn btn-danger" type="submit" name="decline" onclick="window.location.href='loan_request.php?<?=sha1('member_load_repayment_month')?>&<?=md5('member_dof_load_applymember_dof_load_applym')?>&form=loan&member_id=<?=$value['id']?>'">
                                    <span class="docs-tooltip" data-toggle="tooltip" title="Decline Loan">
