<?php
  ...
  include_once './include/session_auth.php';
    ...
    $getMessage = $select->SelectNewMessagesForAdmin();
                   ...
                   <?php
                      ...
                      <tr>
                        ...
                        <td><?=$value['message_subject']?></td>
                         <td><?=$value['member_message']?></td>
                        <td><?=date("H:i:sa".' '."nS".' - '."F".' - '."Y",strtotime($value['member_message_time']))?></td>
                       <!--  <th></th>
                        --> 
                        <th> 
                              <div class="row" style="margin-left: 10px;">
                               ...
                               <div class="btn-group">
                                  <button type="submit" class="btn btn-primary btn-sm" onclick="window.location.href='inbox.php?<?=sha1('aaaaaggggggggggggggggdbbbgbbccbbb')?>&<?=md5('djjgngnnffjgjjfkkfkhmfnnhnn')?>&name=<?=$value['member_name']?>&id=<?=$value['id']?>'">
                                      <i class="fa fa-mail-reply"> Reply</i>
                                  </button>
