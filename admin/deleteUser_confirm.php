<?php
  ...
  include_once './include/session_auth.php';
    ...
    $deleteUser = $insert->Delete_user($id);
          ...
          <div class="row">
                                ...
                                case "success":
                                   echo '
                                    <div class="alert alert-success text-center" style="background-color:darkgreen;">
                                      ...
                                      <strong>Success!</strong> Member Is Successfully Deleted.
                                    </div>';
                                    break;
                                case "nope":
                                    echo '
                                    <div class="alert alert-danger text-center" style="background-color:darkred;">
                                      <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                      <strong>Sorry!</strong> Failed To Delete Member.
                                    </div>';
                                    break;
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <h3 class="text-center">Are You Sure, You Want To Delete This Member</h3>
                  <br />
                  <form method="POST" data-parsley-validate class="form-horizontal form-label-left" style="border-style: none;">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="last-name" value="<?=$_GET['member']?>" required="required" class="form-control col-md-7 col-xs-12" style="border-style: none;">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="col-md-8 col-sm-8 col-xs-12 col-md-offset-4">
                        <a  href="registeredUsers.php" class="btn btn-danger">Back</a>
