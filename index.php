  ...
  -->
        ...
        <div class="line">
          <div class="s-12 m-6 l-6">
            <div class="top-bar-contact">
              <p class="text-size-12">Contact Us: 0800 200 200 | <a class="text-orange-hover" href="mailto:contact@funaicoop.com">contact@funaicoop.com</a></p>
            </div>
          </div>
          <div class="s-12 m-6 l-6">
            <div class="right">
        ...
        <div class="line">
          <div class="margin">
            <div class="s-12 m-12 l-4 margin-m-bottom">
              <img class="margin-bottom" src="img/coop.jpg" alt="">
              <h2 class="text-thin">Mission</h2>
              <p>To create a platform where all the members of the institution will be able to save, borrow funds to meet up with their financial needs through collective contribution.</p>
            </div>
            <div class="s-12 m-12 l-4 margin-m-bottom">
              <img class="margin-bottom" src="img/img-02.jpg" alt="">
              <h2 class="text-thin">Vission</h2>
              <p>To have an enviroment filled with financialy free staff which will help in proper service delivery.</p>
            </div>
            <div class="s-12 m-12 l-4 margin-m-bottom">
              <img class="margin-bottom" src="img/img-03.jpg" alt="">
              <h2 class="text-thin">Totally free</h2>
              <p>Registration is totally free provided you meet up with the demands of the co-operative society.</p>
            </div>
          </div>
        </div>
      </section>
    ...
    <footer>
        ...
        <div class="line">
          <div class="margin">
            ...
            <div class="s-12 m-12 l-4 margin-m-bottom-2x">
              ...
              <p class="text-size-20"><em>"Building one another collectively is the easiest way to financial freedom."</em><p>
                            
              <div class="line">
                <h4 class="text-uppercase text-strong margin-top-30">About Our Co-Operative</h4>
                <div class="margin">
                  <div class="s-12 m-12 l-4 margin-m-bottom">
                    <a class="image-hover-zoom" href="/"><img src="img/blog-04.jpg" alt=""></a>
                  </div>
                  <div class="s-12 m-12 l-8 margin-m-bottom">
                    <p>AE-FUNAI multi purpose co-operative society LTD is a voluntary organization established to enable her member achieve their dream.</p>
            ...
            <div class="s-12 m-12 l-4 margin-m-bottom-2x">
              ...
              <div class="line">
                ...
                <div class="s-11 m-11 l-11 margin-bottom-10">
                  <p><b>Adress:</b> Funai Cooperative building Alex Ekwueme Federal University Ndufu-Alike Ikwo, Ebonyi, Nigeria</p>
                </div>
              </div>
              <div class="line">
                <div class="s-1 m-1 l-1 text-center">
                ...
                <div class="s-11 m-11 l-11 margin-bottom-10">
                  <p><a href="/" class="text-primary-hover"><b>E-mail:</b> contact@funaicoop.com</a></p>
                </div>
              </div>
              <div class="line">
                <div class="s-1 m-1 l-1 text-center">
      ...
      <section class="padding background-dark">
        <div class="line">
          <div class="s-12 l-6">
            <p class="text-size-12">&copy Copyright 2018, Coltek </p>
