      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          ...
          <div class="navbar nav_title" style="border: 0;">
            <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>FunaiCoop!</span></a>
          </div>
             ...
             <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-edit"></i> Forms <span class="fa fa-chevron-down"></span></a>
                  ...
                  <ul class="nav child_menu" style="display: none">
                     <li><a href="membership_form.html">Membership Form</a>
                    </li>
                     <li><a href="form.html">Mandate Form</a>
                    </li>
                     <li><a href="form.html">Thrift Form</a>
                    </li>
                     <li><a href="form.html">Loan Form</a>
                    </li>
                  </ul>
                </li>
                 
              <li><a href="generate_report.html"><i class="fa fa-caret-square-o-right"></i>Generate Report</a> </li>
               <li><a href="message_admin.html"><i class="fa fa-comments-o"></i>Message Admin</a> </li>
                <li><a href="profile.html"><i class="glyphicon glyphicon-user">&nbsp  </i>My Profile</a> </li>
               <li><a href=#><i class="glyphicon glyphicon-comment">&nbsp  </i>Forum</a> </li>
               <li><a href="login.php"><i class="glyphicon glyphicon-off">&nbsp  </i>Log Out</a> </li>
              </ul> 
            </div>
