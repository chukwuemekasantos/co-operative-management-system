          ...
          <div class="row">
           ...
           <div class="x_content">
              ...
              <div class="well well-lg" id="printContent">
                    ...
                    <h4 class="text-center" style="font-size: 31px; color: darkgreen;">MANDATE APPROVAL FORM</h4>
                ...
                <table class="table table-striped">
                   ...
                   <thead class="text-center">
                       <tr>
                          <th>member_prev_deduction</th>
                          <th>member_new_mandate</th>
                          
                        </tr>
                   </thead>
                   <tbody>
                      <tr>
                       <td><?=$_GET["prev_deduction"]?></td>
                       <td><?=$_GET['new_mandate']?></td>
