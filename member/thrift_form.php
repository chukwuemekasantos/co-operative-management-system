                ...
                <div class="x_content">
                  ...
                  <form method="POST" class="form-horizontal form-label-left input_mask" id="t_form.php">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                      ...
                      <input type="concrency" name="member_monthly_contribute" class="form-control has-feedback-left" placeholder="Amount to contriute monthly:(Amount in Figures)" pattern="[0-9]{1,12}" required="">
                      <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                    </div>
