              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <table id="datatable" class="table table-striped table-bordered">
                    ...
                    <?php
                      $loadcheck = $select->SelectUserApprovedLoan($member_id);
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?=date("F".' - '."Y",strtotime($value['member_load_repayment_month']))?></td>
                        <td><?=date("nS".' - '."F".' - '."Y",strtotime($value['member_dof_load_apply']))?></td>
                       <!--  <th></th>
                        --> 
                        <th>
                         
                            <form method="POST" action="print.php?name=<?=$value['member_name']?>&print=<?=$value['id']?>">
                              <div class="row">
