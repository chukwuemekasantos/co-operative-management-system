<?php
  ...
  include_once './include/session_auth.php';
    ...
    $member_id = $_SESSION['members'][0];
      ...
      $print = $select->generateReportForCredit($member_id);
        ...
        <div class="">
          <div class="page-title">
            <div class="title_left">
              <h3>
                    Report Table For Credit <span> <a class="btn btn-success" href="report_l.php" style="font-size: 10px; float: right;">Click For loan Report</a></span>
                </h3>
                ...
                <strong>Sorry!</strong> No Record found.
                  ...
                  <div class="row">
                    ...
                    <div class="row">
                      ...
                      <input type="submit" name="generate" class="btn btn-success" value="Generate Credit Report">
                        </div>
                    </div>
                  </form>
                    ...
                    <?php
                     // $print = $select->generateReport($member_id);
                      ...
                      <tr>
                        ...
                        <td><?=$value['amount_credited']?></td>
                        <td><?=$value['date_of_credit']?></td>
                        <!--  -->
                       <!--  <th></th>
                        --> 
                        <th>
